...
w_count = int(slide.level_downsamples[0][0])//step
...
predictions = cv2.resize([predictions,(int(w_count*step_size/Ds[livel,0],int(h_count*step_size/Ds[livel,0])),interpolation = cv2.INTER_AREA)])
