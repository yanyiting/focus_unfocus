...
top_model=load_model('/cptjack/totem/yanyiting/gray_focus_unfocus/gray/code/Resnet50_gray_jingxi224/ResNet50_gray.hdf5')
...
test_generator = test_datagen.flow_from_directory(test_folders,target_size=(img_width,img_height),batch_size=32,
...
plt.xticks(tick_marks,['focus', 'focus1'],rotation = 45,size = 10)
plt.yticks(tick_marks,['focus', 'focus1'],size = 10)
plt.tight_layout()
...
plt.savefig('/cptjack/totem/yanyiting/gray_focus_unfocus/gray/tmp/mic.png',fotmat = 'png')
