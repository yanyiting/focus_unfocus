...
test_folders = '/cptjack/totem/yanyiting/gray_focus_unfocus/gray/data/2_focus/val'
...
plt.savefig('/cptjack/totem/yanyiting/gray_focus_unfocus/gray/tmp/five_fold.png',fotmat = 'png')
